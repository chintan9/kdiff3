...
class TotalDiffStatus
{
  public:
    ...
    void setBinaryEqualAC(const bool equal)
    {
        bBinaryAEqC = equal;
    }
    void setBinaryEqualBC(const bool equal)
    {
        bBinaryBEqC = equal;
    }
    void setBinaryEqualAB(const bool equal)
    {
        bBinaryAEqB = equal;
    }

    bool isTextEqualAC() const
    {
        return bTextAEqC;
    }
    bool isTextEqualBC() const
    {
        return bTextBEqC;
    }
    bool isTextEqualAB() const
    {
        return bTextAEqB;
    }

    void setTextEqualAC(const bool equal)
    {
        bTextAEqC = equal;
    }
    void setTextEqualBC(const bool equal)
    {
        bTextBEqC = equal;
    }
    void setTextEqualAB(const bool equal)
    {
        bTextAEqB = equal;
    }
